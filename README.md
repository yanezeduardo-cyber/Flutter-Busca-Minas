...
Un clásico juego de Buscaminas desarrollado en formato móvil, web y escritorio utilizando el framework Flutter. Este proyecto ha sido estructurado siguiendo buenas prácticas de diseño de interfaces.

---

### Integrantes / Colaboradores
* **Eduardo Yanez** (`yanezeduardo-cyber`)
* **Victoria Hernandez** (`Victoria030307`)
...
### Arquitectura de Carpetas principales
